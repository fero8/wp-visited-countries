...
For more information visit the [Plugin Homepage](http://wordpress.amellie.net/)

This plugin uses [amMap](http://www.ammap.com/) for displaying a map


== Installation ==

1. Install automatically through the `Plugins` > `Add New` menu in WordPress, or upload the entire `wp-visited-countries` folder to the `/wp-content/plugins/` directory
1. Activate the plugin through the `Plugins` menu in WordPress. A `Visited Countries` menu will then appear in your WordPress admin panel. Click on the menu to configure the settings and add new country


== Frequently Asked Questions ==

Please visit the [Plugin's FAQ](http://wordpress.amellie.net/faq/)
